...
import com.example.talkrr.databinding.ActivitySettingsBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.saveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(SettingsActivity.this, "Information has been updated Successfully", Toast.LENGTH_SHORT).show();
