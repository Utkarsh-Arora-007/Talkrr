...
import com.example.talkrr.databinding.ActivitySignInBinding;
        ...
        binding.btnSignIn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(binding.etEmail.getText().toString().length()==0 || binding.etPassword.getText().toString().length()==0)
                {
                    ...
                    Toast.makeText(SignInActivity.this, "Please Enter all the details Carefully", Toast.LENGTH_SHORT).show();
                    return;
                }
